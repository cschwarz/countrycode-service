...
describe('countries', function () {
    describe('#lookup', function () {
        it('should return AT', function (done) {
            countries.search(16, 48, function (err, country) {
        ...
        it('should return US', function (done) {
            countries.search(-77, 39, function (err, country) {
                expect(err).to.be.null;
                expect(country).to.exist;
